...
| --------- | ----------------------------- | ----------------- | ------------------------ | -------------------------------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| JODU51641 | sercomm                     | COMPAL/NXP          | JODU51641_REL_31_00_00_S                      | uart❓ usb✅                                        | Not yet, Unconfirmed❓       |                                                                                                                              |
| JODU51642 | sercomm                       | COMPAL/NXP        | JODU51641_REL_31_00_00_S                     | uart❓ usb✅(Only fastboot)                          | No❌, fastboot only device   | Fastboot is persistent for an entire boot duration if triggered correctly using hw reset btn. Device is bootloader unlocked. |
| JODU51643 |sercomm                            | COMPAL/NXP                 | JODU51643_REL_31_00_00_S                        | uart❓ usb❓                                                  | ❓                           |                                                                                                                              |
