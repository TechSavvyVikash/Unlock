...
| --------- | ----------------------------- | ----------------- | ------------------------ | -------------------------------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| JODU51641 | sercomm                     | COMPAL/NXP          | JODU51641_REL_31_00_00_S  / Custom Ui✅                    | uart❓ usb✅                                        | yes✅       |                                                                                                                              |
| JODU51642 | sercomm                       | COMPAL/NXP        | JODU51641_REL_31_00_00_S    / Custom Ui✅                 | uart❓ usb✅(Only fastboot)                          | yes✅, fastboot only device   | Fastboot is persistent for an entire boot duration if triggered correctly using hw reset btn. Device is bootloader unlocked. |
| JODU51643 |sercomm                            | COMPAL/NXP                 | JODU51643_REL_31_00_00_S   / Custom Ui✅                     | uart❓ usb❓                                                  | ❓                           |                                                                                                                              |
| JODU51741 | GeneralMobile                 | RG520F-JO(SDX65)  | JODU51741_REL_1315_01_28_S_RIL     | uart❓ usb✅(exposes only fastboot)                  | No❌, fastboot only device   | Device is bootloader unlocked, flashing is possible.                                                                         |
| JODU51740 | GeneralMobile                 | ❓   | JODU51740_REL_1315_01_28_S_RIL     | uart❓ usb✅(exposes only fastboot)                  | No❌, fastboot only device   | Device is bootloader unlocked, flashing is possible.                                                                         |
...
| JODU52140 | SPPEDTECH / NEOLYNC / LUXSLAM | RG520F-JO(SDX65)  | JODU52140_REL_01_15_00_S    | uart✅ usb❌(doesn’t expose any port)                |  yes✅, uart console locked    | LOCKED on latest FW                                                                                                          |
| JODU52240 | Arcadyan                      | RG520F-JO(SDX65)  | JODU52240_REL_01_23_00_S | uart❓ usb❓                                         | Not yet, Unconfirmed❓       | Latest FW updates have disabled the web UI abilities.                                                                        |
| JODU52540 |                               |                   | JODU52540_REL_25_01_05_S | uart✅ usb❓                                         |  yes✅       |                                                                                                                              |
#### TBD: To be determined yet 
#### Firmware_list: yes✅ All available for Download 
